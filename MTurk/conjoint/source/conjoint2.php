...
$featurearray = array("Gender" => array("Boy","Girl"),"Out of Pocket Expenses" => array("$250","$750","$1,000","$2,000","$3,000","$4,000","$5,000","$6,000","$7,500","$10,000"),"Month of Birth" => array("January","February","March","April","May","June","July","August","September","October","November","December"),"Day of Birth" => array(" Weekday"," Weekend"),"Birth Weight" => array("6 pounds 9 ounces","6 pounds 13 ounces","7 pounds 0 ounces","7 pounds 4 ounces","7 pounds 7 ounces","7 pounds 11 ounces","7 pounds 15 ounces","8 pounds 2 ounces","8 pounds 6 ounces","8 pounds 9 ounces"));
$namearray    = array("whether it is a boy or a girl","how much you have to pay out-of-pocket for the hospital birth","in which month the baby is born","whether the baby is born during the week or on the weekend","the weight of the baby at birth");
...
$nameArrayKeys   = array();
$incr = 0;
foreach($namearray as $attribute){	
	$nameArrayKeys[$incr] = $attribute;
	$incr = $incr + 1;
}
...
$attr = 0;
foreach($nameArrayKeys as $attribute){
	// Increment attribute count
	$attr = $attr + 1;

	// Create key for attribute name
	$attr_key = "N-" . (string)$attr;
