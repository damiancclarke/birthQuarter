/* spainPrepFDeaths.do v1.00     damiancclarke             yyyy-mm-dd:2016-02-03
----|----1----|----2----|----3----|----4----|----5----|----6----|----7----|----8

Read in fixed width birth file from Spain using the dictionary file spainMft.dct
then attach labels as described in the online data description files from INE's
site: http://www.ine.es/en/prodyser/micro_mnp_muefet_en.htm

These are all the late fetal deaths between 2007 and 2013 in microdata.
...
*--- (1) Globals
*-------------------------------------------------------------------------------
global DAT "~/database/Spain/muertesfetales"
global DIC "~/investigacion/2015/birthQuarter/source/dataPrep"
global OUT "~/investigacion/2015/birthQuarter/data/spain"

local d2007 "A2007.ANONIMIMFT.TXT"
local d2008 "MFT.A2008"
local d2009 "MFT A2009.txt"
local d2010 "MFT A2010.txt"
local d2011 "datos_muefet11.txt"
local d2012 "datos_muefet12.txt"
local d2013 "Anonimizado MFT sin causa A2013.txt"
...
foreach year of numlist 2007(1)2013 {
    ...
    *--- (2a) Import, destring
    *---------------------------------------------------------------------------
    infile using "$DIC/spainMft0713.dct", using("$DAT/`year'/`d`year''") clear
