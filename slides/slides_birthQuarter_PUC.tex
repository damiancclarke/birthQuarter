...
\scalebox{0.65}{\begin{tabular}{lccccc}
...
\caption{Prevalence of Good Season by Age (relative to 40-45 yo)}
  ...
  \centering
  \includegraphics[scale=0.65]{./../results/nvss/graphs/goodSeasonAge.eps}
\end{figure}
...
\begin{frame}
\frametitle{4. Biological versus Selection Effects}
\begin{table}[htbp]\centering
...
\begin{frame}
\frametitle{6. Occupation and Good Season}
\begin{table}[htbp]\centering
\caption{Season of Birth Correlates: Occupation \label{tab:Occupation}}
\scalebox{0.30}{\begin{tabular}{l*{3}{c}}
\toprule
...
\begin{frame}
\frametitle{8. ``Education, Training and Library'' and Good Season}
\begin{table}[htbp]\centering
...
\begin{table}[htbp]\centering
\caption{Birth Outcomes and Season of Birth (without controls)  \label{tab:qualityMainNC}}
\scalebox{0.65}{
\begin{tabular}{l*{6}{c}}
\toprule
...
\frametitle{11. Good Season and Birth Outcomes}
\begin{table}[htbp]\centering
\caption{Birth Outcomes and Season of Birth (with controls)  \label{tab:qualityMain}}
\scalebox{0.65}{
\begin{tabular}{l*{6}{c}}
\toprule
                    &\multicolumn{1}{c}{(1)}   &\multicolumn{1}{c}{(2)}   &\multicolumn{1}{c}{(3)}   &\multicolumn{1}{c}{(4)}   &\multicolumn{1}{c}{(5)}   &\multicolumn{1}{c}{(6)}   \\
...
\frametitle{11. Good Season and Birth Outcomes}
\begin{table}[htbp]\centering
\caption{Birth Outcomes and Season of Birth (ART Users Only with controls) \label{tab:qualityART}}
\scalebox{0.65}{
\begin{tabular}{l*{6}{c}}
\toprule
                    &\multicolumn{1}{c}{(1)}   &\multicolumn{1}{c}{(2)}   &\multicolumn{1}{c}{(3)}   &\multicolumn{1}{c}{(4)}   &\multicolumn{1}{c}{(5)}   &\multicolumn{1}{c}{(6)}   \\
                    & Birthweight   &         LBW   &        VLBW   &   Gestation   &   Premature   &       APGAR   \\
\midrule
Good Season         &      21.123** &      -0.004   &      -0.002   &       0.054   &       0.001   &       0.029** \\
                    &     [8.643]   &     [0.004]   &     [0.002]   &     [0.038]   &     [0.005]   &     [0.012]   \\
Mother's Age (years)&      -1.149   &       0.001** &       0.000   &      -0.007*  &       0.002***&      -0.003** \\
                    &     [0.958]   &     [0.000]   &     [0.000]   &     [0.004]   &     [0.001]   &     [0.001]   \\
Some College +      &      30.077   &      -0.008   &      -0.000   &       0.287***&      -0.033** &       0.049   \\
                    &    [21.374]   &     [0.010]   &     [0.004]   &     [0.099]   &     [0.013]   &     [0.034]   \\
Smoked in Pregnancy &    -220.282***&       0.060*  &       0.022   &      -0.081   &      -0.012   &      -0.028   \\
                    &    [53.593]   &     [0.031]   &     [0.017]   &     [0.220]   &     [0.030]   &     [0.089]   \\
%Constant            &    3273.559***&       0.077***&       0.007   &      38.455***&       0.119***&       8.770***\\
%                    &    [40.528]   &     [0.019]   &     [0.008]   &     [0.179]   &     [0.024]   &     [0.060]   \\
\midrule
Observations        &       19467   &       19467   &       19467   &       19541   &       19541   &       19519   \\
State and Year FE   &     Y   &     Y   &     Y   &     Y   &     Y   &    Y   \\
%F-test of Age Variables&0.23&0.044&0.206&0.078&0.002&0.048 \\
\bottomrule
\multicolumn{7}{p{15cm}}{\begin{footnotesize}Main estimation
sample is used. Heteroscedasticity robust standard errors are reported in               parentheses.
***p-value$<$0.01, **p-value$<$0.05, *p-value$<$0.1.
...
\item Including \hyperlink{twins}{\beamerskipbutton{Twins}} (Table 6A)
