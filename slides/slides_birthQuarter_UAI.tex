...
\begin{frame}[label=MSum]
  \begin{table}[htpb!]
    ...
    \begin{tabular}{lccccc} \toprule
      \input{./tables/MTurkSum.tex}
      \bottomrule
      \multicolumn{6}{p{13.8cm}}{{\footnotesize\textsc{Notes:} Full sample consists of 3,003 respondents.  The total number of respondents who have had a child is 1,234.  Women over the age of 49 (259 respondents) were not asked questions about pregnancy status and desired future fertility.  The remaining 2,744 respondents were asked these questions.  When the respondent is male, responses refer to the pregnancy of their partner (if present).}}
    \end{tabular}}
  \end{table}
\hyperlink{MMain}{\beamerreturnbutton{Back}}  
\end{frame}
