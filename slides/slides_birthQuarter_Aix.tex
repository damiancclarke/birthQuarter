...
\begin{figure}[htpb!]
  ...
  \end{center}
 \end{figure}
%Follow on results for older mothers
\end{frame}
...
\begin{frame}
  \begin{center}
    \textbf{Results IV: Birth Quality and Season of Birth}
  \end{center}
\end{frame}
...
\frametitle{Biological versus Selection Effects}
  \begin{table}[htbp]\centering
...
\hyperlink{SOBcorr}{\beamerreturnbutton{Back}}
\end{frame}
...
\frametitle{Occupation and Good Season}
\begin{table}[htbp]\centering
...
\begin{frame}
\frametitle{``Education, Training and Library'' and Good Season}
\begin{table}[htbp]\centering
...
\end{footnotesize}}\end{tabular}}\end{table}
\hyperlink{occGraph}{\beamerreturnbutton{Back}}
\end{frame}
